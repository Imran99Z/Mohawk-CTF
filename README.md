...
- Python Wraggling (picoCTF)
- Make sure to install Cryptography for the python script to run (pip install cryptography)
- Trick for Web Exploitation (Just for you Nolan!)

# Be sure to Enjoy and Leave your Comments 
